...
use Vortos\Infrastructure\Doctrine\DomainEventDispatcher;
use Vortos\Persistence\Adapter\DoctrineSourceReader;
use Vortos\Persistence\Adapter\DoctrineSourceWriter;
use Vortos\Persistence\Adapter\MongoProjectionReader;
use Vortos\Persistence\Adapter\MongoProjectionWriter;
use Vortos\Persistence\Contract\PersistenceFactoryInterface;
...
use Vortos\Persistence\CustomType\Uuid;
...
class PersistenceFactory implements PersistenceFactoryInterface
{
    ...
    private function createMongoConnection(array $config = []): MongoDatabase
    {
        ...
        $options = [
            'appname' => $_ENV['APP_NAME'] ?? 'Vortos_App',
