...
namespace Vortos\DependencyInjection\Compiler\Serialize;
...
class SerializerCompilerPass implements CompilerPassInterface
{
    ...
    {
        if (!$container->hasDefinition('vortos.serializer.standard')) {
            return;
        }

        $serializerDefinition = $container->getDefinition('vortos.serializer.standard');
