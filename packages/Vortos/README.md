...
Vortos adheres to the Onion Architecture (also known as Hexagonal/Ports & Adapters).
Plaintext

/
├── config/ # Framework wiring (Routes, Services, Packages)
├── docker/ # Infrastructure definitions (Nginx, PHP, Postgres configs)
├── packages/ # Core Framework components (The "Vortos" vendor code)
...
git clone https://github.com/vortos/vortos.git
cd vortos
